                        ...
                        <li>
                            ...
                            <ul class="mobile-sub-menu">
                                <li>
                                    ...
                                    <ul class="mobile-sub-menu">
                                        <li><a href="produitDetails.php?id=<?php echo $id; ?>">Product Default</a></li>
    ...
    <div class="breadcrumb-section breadcrumb-bg-color--golden">
        <div class="breadcrumb-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="breadcrumb-title">Construisez votre PC dès maintenant</h3>
                                                ...
                                                <div class="accordion">
                                                    ...
                                                    <div id="men-fashion" class="collapse">
                                                        <ul class="accordion-category-list">
                                                            ...
                                                            <li><a href="#">Boite alimentation</a></li>
                                                            <li><a href="#">Carte mére</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <?php foreach ($res as $row) { ?>
                                                    ...
                                                    <div class="col-xl-4 col-sm-6 col-12">
                                                        ...
                                                        <div class="product-default-single-item product-color--golden" data-aos="fade-up" data-aos-delay="0">
                                                            <div class="image-box">
                                                                <a href='produitDetails.php?id=<?php echo $id; ?>&name=<?php echo $row[0]; ?>' class='image-link'>

                                                                    <img src="assets/images/produit/<?php echo $row[6]; ?>" alt="">
                                                                    <?php if ($row[2] == 'Carte Graphique') {
                                                                        echo "<img src='assets/images/produit/cardLogo.png'
                                                                alt=''>";
                                                                    } else if ($row[2] == 'Processeur') {
                                                                        echo "<img src='assets/images/produit/CpuIcon.png'
                                                                alt=''>";
                                                                    } else if ($row[2] == 'Boite Alimentation') {
                                                                        echo "<img src='assets/images/produit/supply.png'
                                                                alt=''>";
                                                                    } else if ($row[2] == 'Ram') {
                                                                        echo "<img src='assets/images/produit/ram.png'
                                                                alt=''>";
                                                                    } else if ($row[2] == 'Boitier') {
                                                                        echo "<img src='assets/images/produit/case.png'
                                                                alt=''>";
                                                                    } else if ($row[2] == 'Carte mére') {
                                                                        echo "<img src='assets/images/produit/mother.png'
                                                                alt=''>";
                                                                    }
                                                                ...
                                                                <div class="action-link">
                                                                    <div class="action-link-left">
                                                                        <a href="#"  data-bs-target="#modalAddcart">Ajouter au panier</a>
                                                                    </div>
                                                            ...
                                                            <div class="content">
                                                                <div class="content-left">
                                                                    <h6 class="title">
                                                                        <a href="produitDetails.php?id=<?php echo $id; ?>"><?php echo $row[0]; ?></a>
                                                                    </h6>
                                                                ...
                                                                <div class="content-right">
                                                                    <span class="price"><?php echo $row[3] . " DT"; ?></span>
                                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="product-list-single product-color--golden">
                                                        <a href="produitDetails.php?id=<?php echo $id; ?>" class="product-list-img-link">
                                                        ...
                                                        <div class="product-list-content">
                                                            <h5 class="product-list-link"><a href="produitDetails.php?id=<?php echo $id; ?>">KAOREET LOBORTIS
                                                                    SAGIT</a></h5>
                                                            <ul class="review-star">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="product-list-single product-color--golden">
                                                        ...
                                                        <div class="product-list-content">
                                                            <h5 class="product-list-link"><a href="produitDetails.php?id=<?php echo $id; ?>">CONDIMENTUM
                                                                    POSUERE</a></h5>
                                                            <ul class="review-star">
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="product-list-single product-color--golden">
                                                        ...
                                                        <div class="product-list-content">
                                                            <h5 class="product-list-link"><a href="produitDetails.php?id=<?php echo $id; ?>">ALIQUAM
                                                                    LOBORTIS</a></h5>
                                                            <ul class="review-star">
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="product-list-single product-color--golden">
                                                        ...
                                                        <div class="product-list-content">
                                                            <h5 class="product-list-link"><a href="produitDetails.php?id=<?php echo $id; ?>">CONVALLIS QUAM
                                                                    SIT</a></h5>
                                                            <ul class="review-star">
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="product-list-single product-color--golden">
                                                        ...
                                                        <div class="product-list-content">
                                                            <h5 class="product-list-link"><a href="produitDetails.php?id=<?php echo $id; ?>">DONEC EU LIBERO
                                                                    AC</a></h5>
                                                            <ul class="review-star">
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
