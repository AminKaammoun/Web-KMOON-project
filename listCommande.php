...
<body>
    ...
    <div class="cart-section">
        ...
        <?php if ($res != NULL) {
            echo "<div class='cart-table-wrapper' data-aos='fade-up' data-aos-delay='0'>
            <div class='container'>
                <div class='row'>
                    <div class='col-12'>
            ...
            foreach ($res as $row) {
                ...
                echo " <tr>
                                        ...
                                        <td class='product_date'>{$row['date']}</td>";
                if ($row['status'] == "Confirmé") {
                    echo "<td class='product_status' style='color:cyan;' ><strong>{$row['status']}</strong></td>
                                    </tr>";
                } else if ($row['status'] == "Préparation") {
                    echo "<td class='product_status' style='color:orange;' ><strong>{$row['status']}</strong></td>
                    </tr>";
                } else if ($row['status'] == "Livraison") {
                    echo "<td class='product_status' style='color:red;' ><strong>{$row['status']}</strong></td>
                    </tr>";
                } else if ($row['status'] == "Livré") {
                    echo "<td class='product_status' style='color:green;' ><strong>{$row['status']}</strong></td>
                    </tr>";
                }
            }

            echo " <!-- Start Cart Single Item-->
...
";
        ...
        <?php if ($res == NULL) {
            echo                        "<div class='empty-cart-section section-fluid'>
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-12 col-md-10 offset-md-1 col-xl-6 offset-xl-3'>
                                                            <div class='emptycart-content text-center'>
                                                                ...
                                                                <h4 class='title'>Aucune Commande disponible</h4>
                                                                <h6 class='sub-title'>
                                                                    Désolé ... Aucun article trouvé dans vos commandes !</h6>
                                                                <a href='#' class='btn btn-lg btn-golden'>Continuer vos achats</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
