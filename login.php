                    ...
                    <div class="account_form" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <form action="php/connexion.php" method="POST">
                            ...
                            <div class="login_submit">
                                <button class="btn btn-md btn-black-default-hover mb-4" type="submit">connexion</button>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="account_form register" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <form class="user" action="php/register.php" method="post">
                            ...
                            <div class="login_submit">
                                <button class="btn btn-md btn-black-default-hover" type="register">Inscrire</button>
                            </div>
                        </form>
                    </div>
                </div>
