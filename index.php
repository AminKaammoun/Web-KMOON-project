                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="hero-slider-content">
                                        <h4 class="subtitle">Nouvelle collection</h4>
                                        <h2 class="title">Construisez le vôtre<br> dès maintenant </h2>
                                        <a href="produitDetails.php?id=<?php echo $id; ?>" class="btn btn-lg btn-outline-golden">Achetez maintenant </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="0">
                            ...
                            <div class="content">
                                <h6 class="title">LIVRAISON GRATUITE</h6>
                                <p>Obtenez 10 % de remise en argent, la livraison gratuite, des retours gratuits et bien plus encore chez plus de 1 000 grands détaillants !
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="content">
                                <h6 class="title">REMBOURSEMENT 30 JOURS</h6>
                                <p>
                                    Satisfaction garantie à 100 % ou remboursement sous 30 jours !</p>
                            </div>
                        </div>
                    </div>
                    <!-- End Service Promo Single Item -->
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="600">
                            ...
                            <div class="content">
                                <h6 class="title">CLIENT FIDÉLITÉ</h6>
                                <p>
                                    Carte pour les 30 % restants de leurs achats à un taux de remise en argent de 1 %.</p>
                            </div>
                        </div>
                    </div>
                    <!-- End Service Promo Single Item -->
