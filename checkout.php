    ...
    <div class="breadcrumb-section breadcrumb-bg-color--golden">
        <div class="breadcrumb-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="breadcrumb-title">Passer commande</h3>
                        <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    <li><a href="index.html">Accueil</a></li>
                                    <li><a href="shop-grid-sidebar-left.html">Magasin</a></li>
                                    <li class="active" aria-current="page">Passer commande</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="checkout_form" data-aos="fade-up" data-aos-delay="400">
                <div class="row">
                    ...
                    <form action="php/confirmCommande.php?id=<?php echo $id; ?>" method="post">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="default-form-box">
                ...
                <input placeholder="adresse de livraison" type="text" name="adress" required />
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="default-form-box">
                <label>Numéro Telephone<span>*</span></label>
        ...
        <div class="col-12 mt-3">
            <div class="order-notes">
                <label for="order_note">Remarque</label>
                <textarea id="order_note" name="remarque" placeholder=""></textarea>
            </div>
        </div>
    </div>
    <div class="order_button pt-3">
        <button class="btn btn-md btn-black-default-hover" type="submit" name="submit">Confirmer commande</button>
    </div>
</form>
                            ...
                            <div class="order_table table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        $sub_tot = 0;
                                        foreach ($res as $row) {
                                            $tot = $row['prix'] * $row['quantity'];
                                            $sub_tot += $tot;
                                            echo "<tr>
                                        <td> {$row['produit_name']} <strong> × {$row['quantity']}</strong></td>
                                        <td>{$tot}.000 DT</td>
                                    </tr>";
                                        } ?>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><?php echo $sub_tot; ?>.000 DT</td>
                                        </tr>
                                        <tr>
                                            <th>Livraison</th>
                                            <td><strong>7.000 DT</strong></td>
                                        </tr>
                                        <tr class="order_total">
                                            <th>Total de la commande</th>
                                            <td><strong><?php echo $sub_tot+7; ?>.000 DT</strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
