    ...
    <div class="breadcrumb-section breadcrumb-bg-color--golden">
        <div class="breadcrumb-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="breadcrumb-title">Panier</h3>
    ...
    <div class="cart-section">
        ...
        <?php if ($res != NULL) {
            ...
            foreach ($res as $row) {
                ...
                $pd = new produit();
                $img = $pd->getImagePanier($row['produit_name']);
                echo " <tr>
                                        <td class='product_remove'><a href='php/removePanier.php?id={$row['id']}&user_id={$id}'><i class='fa fa-trash-o'></i></a>
                                        </td>
                                        <td class='product_thumb'><a href='product-details-default.html'><img
                                                    src='assets/images/produit/{$img}'
                                                    alt=''></a></td>
                                        <td class='product_name'><a href='product-details-default.html'>{$row['produit_name']}</a></td>
                        ...
                        <div class='coupon_code right' data-aos='fade-up' data-aos-delay='400'>
                            ...
                            <div class='coupon_inner'>
                                ...
                                <div class='cart_subtotal'>
                                    <p>Totale</p>
                                    <p class='cart_amount'> $commande_totale.000 DT</p>
                                </div>
                                <div class='checkout_btn'>
                                    <a href='checkout.php?id={$id}' class='btn btn-md btn-golden'>Confirmer commande</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-12 col-md-10 offset-md-1 col-xl-6 offset-xl-3'>
                                                            <div class='emptycart-content text-center'>
                                                                ...
                                                                <h6 class='sub-title'>
                                                                    Désolé ... Aucun article trouvé dans votre panier !</h6>
                                                                <a href='shop-grid-sidebar-left.html' class='btn btn-lg btn-golden'>Continuer vos achats</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
